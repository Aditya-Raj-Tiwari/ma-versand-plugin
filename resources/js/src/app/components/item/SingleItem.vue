        ...
        <div class="row position-relative">
          ...
          <div class="col-12 col-md-5 mt-md-5">
            <div v-stick-in-parent>
              ...
              <h1 class="h2 title mb-3" data-testing="item-name">
                <span>
              ...
              <div class="my-3">
                ...
                <div
                  v-else
                  class="col-12 col-sm-7 col-md-12 col-lg-8 my-3 w-100 basket-container-single-item"
                >
                  <add-to-basket
...
export default {
  ...
  computed: {
    ...
    isDescriptionTabActive() {
      return (
        (App.config.item.itemData.includes("item.description") ||
          App.config.item.itemData.includes("all")) &&
    ...
    isRecommendedPriceActive() {
      return (
        App.config.item.itemData.includes("item.recommendedPrice") ||
        App.config.item.itemData.includes("all")
      );
    },
    ...
    isShortDescriptionActive() {
      return (
        App.config.item.itemData.includes("item.shortDescription") ||
        App.config.item.itemData.includes("all")
      );
    },
    ...
    isTechnicalDataTabActive() {
      return (
        (App.config.item.itemData.includes("item.technical_data") ||
          App.config.item.itemData.includes("all")) &&
    ...
    currentVariation() {
      return get(
        this.$store.state,
        `items[${this.itemId}].variation.documents[0].data`
      );
    },
    ...
    isVariationSelected() {
      return get(
        this.$store.state,
        `items[${this.itemId}].variationSelect.isVariationSelected`
      );
    },
    ...
    attributes() {
      return get(
        this.$store.state,
        `items[${this.itemId}].variationSelect.attributes`
      );
    },
    ...
    units() {
      return get(
        this.$store.state,
        `items[${this.itemId}].variationSelect.units`
      );
    },
  ...
  created() {
    ...
    this.$store.commit(
      ...
      this.pleaseSelectOptionVariationId
    );
  },
  ...
  mounted() {
    this.$nextTick(() => {
      this.$store.dispatch(
        `${this.itemId}/variationSelect/setVariationSelect`,
        {
          itemId: this.itemId,
