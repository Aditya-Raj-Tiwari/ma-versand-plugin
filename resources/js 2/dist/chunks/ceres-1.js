...
/* harmony import */ var _OrderPropertyValueListItem_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./OrderPropertyValueListItem.vue */ "./resources/js/src/app/components/item/OrderPropertyValueListItem.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    OrderPropertyValueListItem: _OrderPropertyValueListItem_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  props: {
    basketItem: {
      required: true,
  ...
  computed: {
    shownProperties: function shownProperties() {
      ...
      this.basketItem.variation.data.properties.forEach(function (property) {
        ...
        if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_10__["isDefined"])(filledProperty)) {
        ...
        if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_10__["isDefined"])(filledProperty) || _this.isPropertyWithAdditionalCosts(property)) {
