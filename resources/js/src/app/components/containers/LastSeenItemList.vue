<template>
  <div class="row cross-selling categoriegrid">
    ...
    <div class="col-12">
      <carousel
        v-if="mountedItems && mountedItems.length > 0"
        ...
        <template slot="items" v-for="item in items">
          ...
          >
            <template #before-prices>
              <div
                v-html="getContainerContentById(item.id, 'beforePrices')"
              ></div>
            </template>
            <template #after-prices>
              <div
                v-html="getContainerContentById(item.id, 'afterPrices')"
              ></div>
            </template>
          </category-item>
        </template>
