...
/* harmony import */ var _OrderPropertyValueListItem_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./OrderPropertyValueListItem.vue */ "./resources/js/src/app/components/item/OrderPropertyValueListItem.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    OrderPropertyValueListItem: _OrderPropertyValueListItem_vue__WEBPACK_IMPORTED_MODULE_10__["default"]
  },
  props: {
    basketItem: {
      required: true,
  ...
  computed: {
    shownProperties: function shownProperties() {
      ...
      this.basketItem.variation.data.properties.forEach(function (property) {
        ...
        if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_9__["isDefined"])(filledProperty)) {
        ...
        if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_9__["isDefined"])(filledProperty) || _this.isPropertyWithAdditionalCosts(property)) {
          shownProperties.push(property);
        }
      });
      var requiredPropertyIds = [82, 83, 84];
      var foundProperties = shownProperties.filter(function (property) {
        return requiredPropertyIds.includes(property.propertyId);
      });
      var dateString = "";
      if (foundProperties.length === 3) {
        ...
        dateString = foundProperties.map(function (property) {
          return property.property.value;
        }).join(".");
      }
      this.date = dateString;
      var excludedPropertyIds = [2, 3, 4, 9, 82, 83, 84, 70];
      var filteredProp = shownProperties.filter(function (property) {
        return !excludedPropertyIds.includes(property.propertyId);
      });
      return filteredProp;
    },
    dateComp: function dateComp() {
      return this.date;
    }
  },
  methods: {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _vm._l(propertyGroup.properties, function (property) {
      return _c("div", [propertyGroup.name ? _c("strong", [_vm._v(_vm._s(propertyGroup.name) + ":\n          ")]) : _vm._e(), _vm._v(" "), _c("span", [_vm._v(_vm._s(property.names.name))]), _vm._v(" "), property.cast == "file" ? _c("span", [_c("a", {
        attrs: {
...
var render = function render() {
  ...
  return _vm.shownProperties && _vm.shownProperties.length ? _c("div", {
    staticClass: "card px-4 border-0"
  }, [_c("ul", {
    staticClass: "order-property-list list-unstyled row d-flex justify-content-between p-3 mb-0",
    attrs: {
      "data-testing": "order-property-list"
    }
  }, [_vm.dateComp ? _c("li", [_c("span", {
    staticClass: "d-block"
  }, [_c("strong", [_vm._v(" Geburtstag : ")]), _vm._v(" "), _c("span", [_c("span", [_vm._v(" " + _vm._s(_vm.dateComp) + " ")])])])]) : _vm._e(), _vm._v(" "), _vm._l(_vm.shownProperties, function (property) {
